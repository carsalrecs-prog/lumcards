...
class ServerTests(unittest.TestCase):
    ...
    def test_01_static_and_initial_state(self):
        ...
        self.assertIn('/app.js?v=20260917-web-study-blocks', page)
    ...
    def test_student_stylesheet_is_served_for_both_screens(self):
        for route in ('/', '/practice.html'):
            self.assertIn('/student.css?v=20260917-web-study-blocks', self.request(route, raw=True).decode())
        with urllib.request.urlopen(self.url + '/student.css?v=20260917-web-study-blocks') as response:
