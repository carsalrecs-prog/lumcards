...
// ── Test 7: Cache version coherence ─────────────────────────────
{
  ...
  assert.match(sw, /20260917-(csp|blocks|import-menus|practice-folders)/, 'SW CACHE_NAME should include 20260917-csp, blocks, import-menus or practice-folders');
  // index.html references should match
  assert.match(indexHtml, /app\.css\?v=20260917-(csp|blocks|import-menus|practice-folders)/, 'index.html should reference app.css?v=20260917');
  assert.match(indexHtml, /student\.css\?v=20260917-(csp|blocks|import-menus|practice-folders)/, 'index.html should reference student.css?v=20260917');
  assert.match(indexHtml, /app\.js\?v=20260917-(csp|blocks|import-menus|practice-folders)/, 'index.html should reference app.js?v=20260917');

  assert.match(practiceHtml, /app\.css\?v=20260917-(csp|blocks|import-menus|practice-folders)/, 'practice.html should reference app.css?v=20260917');
  assert.match(practiceHtml, /practice\.css\?v=20260917-(csp|blocks|import-menus|practice-folders)/, 'practice.html should reference practice.css?v=20260917');
  assert.match(practiceHtml, /practice\.js\?v=20260917-(csp|blocks|import-menus|practice-folders)/, 'practice.html should reference practice.js?v=20260917');
