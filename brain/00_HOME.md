...
- [[01_CURRENT|Estado actual]] — qué funciona y qué está realmente verificado.
- [[02_NEXT|Próximas tareas]] — prioridades y criterio de finalización.
- [[03_DECISIONS|Decisiones]] — acuerdos duraderos y asuntos pendientes.
- [[04_LOG|Registro]] — últimas sesiones, resultado y pruebas.
...
Al iniciar, lee esta nota, el relevo y la ficha relevante. Guarda avances por hitos y antes de terminar o cambiar de agente. Las pruebas y el código prevalecen frente a notas antiguas. No guardar conversaciones ni datos de la biblioteca. Mantener esta portada por debajo de 4.000 caracteres.
